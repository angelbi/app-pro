<template>
  <a-card :bordered="false">
    ...
    <a-modal
      ...
      :maskClosable="false"
    >
      <jhi-announcement-record-update @cancel="updateModalCancel" :showInModal="true" :updateEntityId="announcementRecordId" />
    </a-modal>
  </a-card>
</template>

<script lang="ts" src="./announcement-record.component.ts"></script>
<style>
