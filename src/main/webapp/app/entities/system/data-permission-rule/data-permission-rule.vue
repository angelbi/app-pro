<template>
  <a-card :bordered="false">
    ...
    <a-modal
      ...
      :maskClosable="false"
    >
      <jhi-data-permission-rule-update @cancel="updateModalCancel" :showInModal="true" :updateEntityId="dataPermissionRuleId" />
    </a-modal>
  </a-card>
</template>

<script lang="ts" src="./data-permission-rule.component.ts"></script>
<style>
