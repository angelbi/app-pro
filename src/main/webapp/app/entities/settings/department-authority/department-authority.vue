<template>
  <a-card :bordered="false">
    ...
    <a-modal
      ...
      :maskClosable="false"
    >
      <jhi-department-authority-update @cancel="updateModalCancel" :showInModal="true" :updateEntityId="departmentAuthorityId" />
    </a-modal>
  </a-card>
</template>

<script lang="ts" src="./department-authority.component.ts"></script>
<style>
