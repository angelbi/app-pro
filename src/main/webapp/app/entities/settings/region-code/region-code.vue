<template>
  <a-card :bordered="false">
    ...
    <a-modal
      ...
      :maskClosable="false"
    >
      <jhi-region-code-update @cancel="updateModalCancel" :showInModal="true" :updateEntityId="regionCodeId" :parentId="parentId" />
    </a-modal>
  </a-card>
</template>

<script lang="ts" src="./region-code.component.ts"></script>
<style>
